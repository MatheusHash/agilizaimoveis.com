...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="slider-filtros" id="slider-filtros-2">
                                    ...
                                    <ul>
                                        ...
                                        <?php $__currentLoopData = $municipios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <li class="cidade-item"><a data-name="cidade" data-value="<?php echo e($municipio->id); ?>"
        ...
        <div id="right-imoveis">
            ...
            <div id="abas-filtro">
                ...
                <a href="<?php echo e(route('comprar', ['motivo' => $motivo])); ?>" <?php if($motivo == 2 || $motivo == 3): ?> class="ativo"
                <?php endif; ?>>Comprar</a>

                <a href="<?php echo e(route('alugar', ['motivo' => $motivo])); ?>" <?php if($motivo == 1 || $motivo == 3): ?> class="ativo"
                <?php endif; ?>>Alugar</a>
