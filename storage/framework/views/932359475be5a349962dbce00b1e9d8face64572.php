    ...
    <section class="bg-gray-800 w-full">
        ...
        <div id="search" class="container grid col-12">
            <div class="mx-auto col-12 w-8/12">
                <form action="<?php echo e(route('imoveis.show')); ?>" class="mx-auto grid" method="GET">
                    <?php echo csrf_field(); ?>
            ...
            <div class="bg-gray-500 rounded px-5">
                ...
                <h5 class=" h-16 text-white text-[24px] font-semibold text-right">
                    <span class="bg-orange-600 px-4 py-1 rounded-[10px]">
                        <?php echo e($qtd); ?> imóveis
                    </span>

                </h5>
                <div class="text-right">
                    <a class="text-white hover:bg-gray-700 rounded-[10px]   " href="<?php echo e(route('imoveis.show')); ?>">Ver
                        todos</a>
                </div>
            </div>
                    ...
                    <div class="text-white px-8 py-4 border border-gray-700 rounded-[16px]">
                        <div class="flex justify-between">
                            <div class="grid self-start ">
                                <h3 class="text-blue-600 font-light text-[24px]"><?php echo e($imovel->titulo); ?>

                                    <span class="text-[16px]">{ <?php echo e($imovel->id); ?> }</span>
                                </h3>
                                <div>

                                    <h4 class="text-[16px]"> R$ <?php echo e(number_format($imovel->valor, 2, ',', '.')); ?></h4>
                                </div>
                            </div>
                            <div>

                                <h3 class="opacity-25 cursor-not-allowed">inserido em:
                                    <?php echo e(date('d-m-Y', strtotime($imovel->created_at))); ?> por: <?php echo e($imovel->corretor); ?> </h3>

                            </div>
                            <span class="grid gap-2 text-blue-500 text-[18px] mr-10 text-center">

                                <?php if(empty(!$imovel->municipio)): ?>
                                    <h3><?php echo e($imovel->municipio->nome); ?> </h3>
                                <?php endif; ?>

                                <?php if(empty(!$imovel->bairro)): ?>
                                    <span><?php echo e($imovel->bairro->nome); ?></span>
                                <?php endif; ?>
                            </span>
                        </div>
                        <div class="flex mx-auto  w-11/12 ">
                            <div class="w-4/12 ">
                                <?php if($imovel->fotoPrincipal): ?>
                                    <img class="max-h-64 h-64 rounded-[8px]"
                                        src="<?php echo e(asset($imovel->fotoPrincipal->path)); ?>" />
                                <?php else: ?>
                            ...
                            <div class=" px-6 w-8/12 bg-gray-400 bg-opacity-5">
                                <div class="w-10/12">
                                    ...
                                    <p class="text"><?php echo $imovel->descricao; ?></p>
                                </div>
                                <p class="text-blue-600 mt-5"><?php echo e($imovel->endereco); ?> </p>
                            </div>

                            <div class="grid grid-cols-1 font-bold gap-1 max-h-64">
                                <button onclick="window.location.href='<?php echo e(route('galeria', $imovel->id)); ?>';"
                                ...
                                <button data-tipo="visibilidade" data-value="<?php echo e($imovel->id); ?>"
                                    class="px-3 uppercase flex justify-center items-center bg-blue-600 text-white">
                                    <?php if($imovel->visibility): ?>
                                        <span data-tipo="visibilidade" data-value="<?php echo e($imovel->id); ?>"
                                ...
                                <button onclick="window.location.href='<?php echo e(route('imoveis.edit', $imovel->id)); ?>';"
                                    class="px-3  uppercase flex justify-center items-center bg-yellow-600 text-white">
                                    <span class="material-symbols-outlined">edit</span>
                                    Editar
                                </button>

                                <button data-tipo="delete" data-value="<?php echo e($imovel->id); ?>"
                                    class="px-3 uppercase flex justify-center items-center bg-red-600 text-white">
                                    <span data-tipo="delete" data-value="<?php echo e($imovel->id); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/coffcoff/Documents/Projects/agilizaimoveis.com/resources/views/admin/imoveis/listaDeImoveis.blade.php ENDPATH**/ ?>