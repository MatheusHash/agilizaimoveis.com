...
<div id="container-page" class="interna">
    ...
    <div class="container">
        <div id="tit-imoveis-lancamentos">
            <h6>Descubra os Lançamentos Exclusivos da
                <span>
                    Agiliza Imóveis
                </span>
            </h6>
            <p>Descubra a diversidade de lançamentos imobiliários da Agiliza Imóveis, criados para cada estilo de vida e
                desejo.</p>
        </div>
        ...
        <?php if($imoveis): ?>
            ...
            <div id="list-imoveis" style="min-height: 300px">
...
<?php /**PATH /home/coffcoff/Documents/Projects/agilizaimoveis.com/resources/views/lancamentos/index.blade.php ENDPATH**/ ?>