...
<script>
    ...
    contatoForm.addEventListener("submit", (e)=>{
        ...
        const dataForm = new FormData(contatoForm);
        let data = [];
        for(let char of dataForm){
            data.push(char);
        }
        let novoData = arrayToObj(data);
        sendMessage(novoData);

    })
</script>
<?php /**PATH /home/coffcoff/Documents/Projects/agilizaimoveis.com/resources/views/template/formularioContato.blade.php ENDPATH**/ ?>