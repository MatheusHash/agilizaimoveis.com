<div class=" bg-white p-10">
    ...
    <div class="max-w-4xl mx-auto p-6">
        <form id="uploadForm" action="<?php echo e(route('admin.homepage.slider.store')); ?>" method="POST"
    ...
    <div id="imageGrid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div data-id="<?php echo e($image->id); ?>"
                class="image-item relative group border rounded overflow-hidden shadow hover:shadow-lg transition cursor-move">
                <img src="<?php echo e(asset($image->path)); ?>" class="w-full h-48 object-cover" alt="Imagem da homepage">
                <button onclick="deleteImage(<?php echo e($image->id); ?>)"
...
</script><?php /**PATH /home/mhash/Documents/Projects/agilizaimoveis.com/resources/views//admin/homepage/slider.blade.php ENDPATH**/ ?>