...
<?php echo $__env->first(['template.top'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div id="container-page" class="interna">
    ...
    <div class="container">
        <div id="tit-qtd-imoveis">
            <h6><?php echo e($imoveis->total()); ?> imóveis disponíveis</h6>
        </div>


        <div id="left-imoveis">

            <form action="<?php echo e(route('imoveis.filtrados.home')); ?>" method="GET">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="slider-filtros" id="slider-filtros-2">
                                    <ul>
                                        <?php $__currentLoopData = $municipios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $municipio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="cidade-item"><a data-name="cidade"
                                                    data-value="<?php echo e($municipio->id); ?>"
                                                    data-tipo="<?php echo e($municipio->nome); ?>"><?php echo e($municipio->nome); ?></a></li>
        ...
        <div id="right-imoveis">
            ...
            <div id="abas-filtro">
                ...
                <a href="<?php echo e(route('comprar', ['motivo' => $motivo])); ?>"
                    <?php if($motivo == 2 || $motivo == 3): ?> class="ativo" <?php endif; ?>>Comprar</a>
                <a href="<?php echo e(route('alugar', ['motivo' => $motivo])); ?>"
                    <?php if($motivo == 1 || $motivo == 3): ?> class="ativo" <?php endif; ?>>Alugar</a>
            </div>

            

            <div id="list-imoveis">
                <?php if(count($imoveis) < 1): ?>
                    <p>No momento não temos um imóvel com estes requisitos. <br> Entre em contato para mais informações.
                    </p>
                <?php endif; ?>

                <?php $__currentLoopData = $imoveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $imovel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="box-imovel">

                        <div class="container-slider-imovel">

                            <div class="slider-imovel" id="slider-imovel-<?php echo e($key + 1); ?>">

                                <div class="swiper-wrapper">

                                    <?php if($imovel->fotoPrincipal): ?>
                                        <div class="swiper-slide">
                                            <a><img src="<?php echo e(asset($imovel->fotoPrincipal->path)); ?>"
                                                    alt="Imagem do Imóvel <?php echo e($imovel->id); ?>"></a>
                                        </div>
                                    <?php endif; ?>

                                    <?php if($imovel->galeria): ?>
                                        <?php for($i = 0; $i < count($imovel->galeria); $i++): ?>
                                            <div class="swiper-slide">
                                                <a><img src="<?php echo e(asset($imovel->galeria[$i]->path)); ?>"
                                                        alt="Imagem do Imóvel <?php echo e($imovel->id); ?>"></a>
                                            </div>
                                        <?php endfor; ?>
                                    <?php endif; ?>
                            ...
                            <div class="navs-slider-imovel">
                                <a id="prev-imovel-<?php echo e($key + 1); ?>">
                                ...
                                <a id="next-imovel-<?php echo e($key + 1); ?>">
                            ...
                            <div class="pager-slider-imovel" id="pager-slider-imovel-<?php echo e($key + 1); ?>">
                            </div>

                            <?php if($imovel->ocultarValorParaCliente): ?>
                            ...
                            <script>
                                const swiperImovel<?php echo e($key + 1); ?> = new Swiper('#slider-imovel-<?php echo e($key + 1); ?>', {
                                    slidesPerView: 1,
                                    spaceBetween: 2,
                                    freeMode: true,
                                    ...
                                    loop: true,
                                    navigation: {
                                        nextEl: '#next-imovel-<?php echo e($key + 1); ?>',
                                        prevEl: '#prev-imovel-<?php echo e($key + 1); ?>',
                                    },
                                    pagination: {
                                        el: '#pager-slider-imovel-<?php echo e($key + 1); ?>',
                                        clickable: true
                                    }
                                });
                            </script>
                        ...
                        <div class="info-list-imovel">
                            <h5><?php echo e($imovel->titulo); ?></h5>
                            <small id="imovel">Código do imóvel: <?php echo e($imovel->id); ?></small>
                            <?php if($imovel->bairro): ?>
                                <small id="imovel">bairro - <?php echo e($imovel->bairro->nome); ?></small>
                                <!-- <div class="bairro">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <p>
                                        <span><?php echo e($imovel->quarto); ?></span><br>
                                        quartos
                                    </p>
                                </li>
                                <li>
                                    <figure>
                                        <svg id="Camada_1" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 304.62 382.58">
                                            <path
                                    ...
                                    <p>
                                        <span><?php echo e($imovel->banheiro); ?></span><br>
                                        banheiros
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>
                                        <span><?php echo e($imovel->suite); ?></span><br>
                                        suíte
                                    </p>
                                </li>
                                <li>
                                    ...
                                    <p>
                                        <span><?php echo e($imovel->garagem); ?></span><br>
                                        vagas
                                    </p>
                                </li>
                            </ul>
                            <div class="bts-list-imovel">
                                <a id="detalhes-imovel-<?php echo e($imovel->id); ?>"
                                    href="<?php echo e(route('imovel', [$imovel->id])); ?>">Detalhes</a>
                                <a onClick="showForm();" data-value="<?php echo e($imovel->id); ?>">Contatar</a>
                                

                                <a id="compartilhar"
                                    href="https://api.whatsapp.com/send?text=Olha este imóvel incrível disponível na Agiliza Imóveis: <?php echo e(route('imovel', [$imovel->id])); ?>"
                                    target="_blank" rel="noopener external nofollow"
                                    aria-label="Compartilhe o Imóvel <?php echo e($imovel->titulo); ?> no WhatsApp">
        ...
        <div id="paginacao">
            <?php echo e($imoveis->appends($parameters)->links('shared.pagination')); ?>
        </div>
...
<script type="text/javascript" src="<?php echo e(asset('/js/archives/formContato.js')); ?>"></script>
...
<?php echo $__env->first(['template.bottom'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH /home/mhash/Documents/Projects/agilizaimoveis.com/resources/views/imoveis/index.blade.php ENDPATH**/ ?>