<section class="bg-white">
    <div class="max-w-4xl mx-auto p-6">
        ...
        <form action="<?php echo e(route('admin.homepage.empreendimento.store')); ?>" method="POST" enctype="multipart/form-data"
            ...
            <!-- Preview (JS opcional, mas mantemos pra ajudar o usuário visualmente) -->
        ...
        <div id="lista-empreendimentos" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <?php $__currentLoopData = $empreendimentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    ...
                    <!-- Botão excluir -->
                    <form action="<?php echo e(route('admin.homepage.empreendimento.destroy', ['id' => $emp->id])); ?>" method="POST"
                    ...
                    <img src="<?php echo e(asset($emp->imagem_capa_path)); ?>" class="w-full h-36 object-cover rounded-md">
                    <h4 class="text-lg font-semibold mt-2"><?php echo e($emp->titulo); ?></h4>
                    <p class="text-gray-600 text-sm mt-1"><?php echo e($emp->descricao); ?></p>
                </div>
...
</script><?php /**PATH /home/mhash/Documents/Projects/agilizaimoveis.com/resources/views//admin/homepage/empreendimentos.blade.php ENDPATH**/ ?>