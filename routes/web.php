...
use App\Http\Controllers\admin\EmpreendimentoController;
...
Route::middleware('auth')->group(function () {
    //Middleware para autenticar o usuario antes de entrar nas rotas Admin
    Route::prefix('admin')->group(function () { // Grupo de rotas Admin
        Route::get('/dashboard', [\App\Http\Controllers\admin\DashboardController::class, 'index'])->name('dashboard');
        Route::get('/homepage', [\App\Http\Controllers\admin\HomePageController::class, 'page'])->name('homepage.page');
        Route::prefix('homepage-slider')->group(function () {
            Route::get('/', [HomepageSliderController::class, 'index'])->name('admin.homepage.slider');
            Route::post('/', [HomepageSliderController::class, 'store'])->name('admin.homepage.slider.store');
            Route::delete('/{id}', [HomepageSliderController::class, 'destroy'])->name('admin.homepage.slider.destroy');
        });
        Route::prefix('empreendimentos')->group(function () {
            Route::get('/', [EmpreendimentoController::class, 'index'])->name('admin.homepage.empreendimento');
            Route::post('/', [EmpreendimentoController::class, 'store'])->name('admin.homepage.empreendimento.store');
            Route::delete('/{id}', [EmpreendimentoController::class, 'destroy'])->name('admin.homepage.empreendimento.destroy');
        });
        ...
        Route::prefix('posts')->group(function () {
            Route::get('/', [App\Http\Controllers\admin\HomePageController::class, 'index'])->name('posts.index');
            Route::post('/create', [App\Http\Controllers\admin\HomePageController::class, 'store'])->name('posts.store');
