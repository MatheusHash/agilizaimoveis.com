    ...
    <div class="container">
        ...
        <div id="right-imoveis">
            ...
            <div id="abas-filtro">
                ...
                <a href="{{ route('comprar', ['motivo' => $motivo]) }}"
                    @if ($motivo == 2 || $motivo == 3) class="ativo" @endif>Comprar</a>
                <a href="{{ route('alugar', ['motivo' => $motivo]) }}"
                    @if ($motivo == 1 || $motivo == 3) class="ativo" @endif>Alugar</a>
            </div>
