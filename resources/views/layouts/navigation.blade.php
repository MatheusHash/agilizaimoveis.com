<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('imoveis.store.form')" :active="request()->routeIs('imoveis.store.form')">

                {{ __('Inserir Imóvel') }}

            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('imoveis.show')" :active="request()->routeIs('imoveis.show')">

                {{ __('Listar Imóveis') }}

            </x-responsive-nav-link>

            {{-- <x-responsive-nav-link :href="route('cidades.index')" :active="request()->routeIs('cidades.index')">
            ...
            <x-responsive-nav-link :href="route('municipios.index')" :active="request()->routeIs('municipios.index')">
